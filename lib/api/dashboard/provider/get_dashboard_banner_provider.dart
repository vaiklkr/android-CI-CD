...
class GetDashboardBannerApi {
  Future<GetDashboardBannerModel?> onGetDashboardBannerApi() async {
    try {
      final uri = Uri.parse(Config.dashboardURL + Config.getDashboardBanner);
      ...
      if (response.statusCode == 200) {
        ...
        return GetDashboardBannerModel.fromJson(responseJson);
      } else {
        return null;
      }
    } catch (exception) {
