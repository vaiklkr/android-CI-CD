...
class VerifyAadharApi {
  Future<dynamic> onVerifyAadharApi(
    String adhaarnumber,
  ) async {
    try {
      final uri = Uri.parse(Config.kycURL + Config.verifyAadhar);
      dynamic postData = {
      ...
      if (response.statusCode == 200) {
        ...
        return VerifyAadhaarModel.fromJson(responseJson);
