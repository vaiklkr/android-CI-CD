...
class GetMarketingDataApi {
  Future<dynamic> onGetMarketingDataApi() async {
    try {
      final uri = Uri.parse(Config.marketingURL + Config.getMarketingData);
      ...
      if (response.statusCode == 200) {
        ...
        return GetMarketingDataModel.fromJson(responseJson);
