...
class VerifyBankNameIFSCApi {
  Future<dynamic> onVerifyBankNameIFSCApi(String ifscnum) async {
    try {
      final uri =
          Uri.parse(Config.kycURL + Config.verifyBankNameIFSC + ifscnum);
      ...
      if (response.statusCode == 200) {
        ...
        return VerifyBankNameByIFSCModel.fromJson(responseJson);
