...
class InsertVPADetailsApi {
  Future<dynamic> onInsertVPADetailsApi(
    String vpaNum,
    String vpaHolderName,
  ) async {
    try {
      final uri = Uri.parse(Config.kycURL + Config.insertVPADetails);
      ...
      if (response.statusCode == 200) {
        ...
        return InsertVPADetailsModel.fromJson(responseJson);
